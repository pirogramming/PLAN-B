...
class ProgressRecordViewTests(TestCase):
    ...
    def test_record_done_status(self):
        ...
        self.assertEqual(data['result']['actual_minutes'], 45)
    ...
    def test_record_partial_status(self):
        ...
        data = response.json()
        self.assertTrue(data['isSuccess'])
        self.assertEqual(data['result']['completion_percent'], 50)
    ...
    def test_record_not_done_status(self):
        ...
        data = response.json()
        self.assertTrue(data['isSuccess'])
        self.assertEqual(data['result']['actual_minutes'], 0)
    ...
    def test_rejects_other_user_item(self):
    ...
    def test_rejects_edit_after_finalized(self):
        ...
        data = response.json()
        self.assertFalse(data['isSuccess'])
        self.assertEqual(data['code'], 'PROGRESS4091')
